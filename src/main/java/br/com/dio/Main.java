...
public class Main {
    ...
    private static void createAccount(){
        ...
        System.out.println("Conta: '" + wallet + "' criada com sucesso");
    }
    ...
    private static void incInvestment(){
        ...
        var pix = scanner.next();
        System.out.println("Informe o valor que será invetido: ");
        var amount = scanner.nextLong();
        try {
    ...
    private static void checkHistory() {
        ...
        try {
            ...
            sortedHistory.forEach((date, audities) -> {
                ...
                System.out.println(audities.get(0).transactionId());
                System.out.println(audities.get(0).description());
                System.out.println(audities.size());
            });
